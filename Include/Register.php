<form class="needs-validation" action="Register.php" method="post">  
    <div class="form-row">
        <div class="divform">
            <input type="hidden" name="id" id="cakeId" value="<?= $cake=null ? $cake->id : '' ?>">
            <div class="col-md-8 mb-3" style="margin-left: 1rem">
                <label for="validationTooltip01">Cake Name</label>
                <input name="cake" type="text" value="<?= $cake=null ? $cake->name : '' ?>" class="form-control" id="validationTooltip01" placeholder="Name of your cake" required>
            ...
            <div class="col-md-8 mb-3" style="margin-left: 1rem">
                ...
                <input name="cakePrice" type="text" value="<?= $cake=null ? $cake->price : '' ?>"class="form-control" id="validationTooltip02" placeholder="Price of your cake" required>
                <div class="valid-tooltip">
                Looks good!
                </div>
            </div>
